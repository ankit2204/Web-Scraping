...
page_url='http://www.myntra.com/kurtas-and-suits-menu?src=tNav'
...
element_one = driver.find_elements_by_tag_name('input')
element_two = driver.find_element_by_xpath("//div[@data-filter='brands_filter_facet'][@class='panel']")
element_three = element_two.find_elements_by_tag_name('li')



for ele_three in element_three:
	...
	workbook = xlsxwriter.Workbook('myntra_products_by_brand.xlsx')
	...
	for each_li in all_li:
		...
		try:
			...
			worksheet.write(row, col+11, ele_three.text)
